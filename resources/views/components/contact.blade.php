<div id="contact" class="scroll-section mt-32 xl:px-32 lg:px-5 px-3 sm:px-5">
    ...
    <div class="flex max-lg:flex-col items-center gap-16 lg:mt-10 mt-5">
        <div class="border border-[#C7EEFF] rounded-xl lg:p-6 sm:p-9 p-6 lg:w-[50%] w-full shadow-behind shadow-gray">
            ...
            @endif
            <h2 class="text-xl sm:text-3xl lg:text-2xl font-bold text-center mb-2 sm:mb-5 lg:mb-3 underline">Contact Form</h2>
            <form 
                x-data="{
                    name: '',
                    email: '',
            ...
            <p class="text-center text-sm mt-10 tracking-wider font-light">
                Or send me mail by 
                <a href="mailto:roshinante678@gmail.com" class="inline-flex group items-center justify-center underline text-gray-300 hover:text-gray-400 transition font-bold">
        ...
        <div class="flex flex-col gap-4 lg:w-[50%] w-full">
            <div class="flex gap-3">
                ...
                <div class="leading-normal">
                    <h3 class="font-bold lg:text-2xl sm:text-xl text-base tracking-wide">Chat with me on WhatsApp</h3>
                    <p class="tracking-wide font-extralight sm:text-base text-sm max-sm:my-1">Feel free to drop a message or discuss your ideas directly.</p>
                    <a href="https://wa.me/6289670336495" class="font-medium tracking-wider inline-flex group items-center justify-center transition" target="_blank">
                        <span class="sm:text-base text-sm text-[#C7EEFF] group-hover:underline ">Start chatting on WhatsApp</span>
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 ml-1 group-hover:translate-x-1.5 transition group-hover:-translate-y-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#C7EEFF"><path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <div class="leading-normal">
                    <h3 class="font-bold lg:text-2xl sm:text-xl text-base tracking-wide">Discover my GitHub projects</h3>
                    <p class="tracking-wide font-extralight sm:text-base text-sm max-sm:my-1">Explore my repositories and see what I've been working on.</p>
                    <a href="https://github.com/alfreezzz" class="font-medium tracking-wider inline-flex group items-center justify-center transition" target="_blank">
                        <span class="sm:text-base text-sm text-[#C7EEFF] group-hover:underline ">Visit my GitHub profile</span>
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 ml-1 group-hover:translate-x-1.5 transition group-hover:-translate-y-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#C7EEFF"><path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <div class="leading-normal">
                    <h3 class="font-bold lg:text-2xl sm:text-xl text-base tracking-wide">Connect with me on LinkedIn</h3>
                    <p class="tracking-wide font-extralight sm:text-base text-sm max-sm:my-1">Let's collaborate and grow our professional network together.</p>
                    <a href="https://www.linkedin.com/in/alfriza-akhmad-rahadi-a22896343/" class="font-medium tracking-wider inline-flex group items-center justify-center transition" target="_blank">
                        <span class="sm:text-base text-sm text-[#C7EEFF] group-hover:underline">Check out my LinkedIn profile</span>
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 ml-1 group-hover:translate-x-1.5 transition group-hover:-translate-y-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#C7EEFF"><path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <div class="leading-normal">
                    <h3 class="font-bold lg:text-2xl sm:text-xl text-base tracking-wide">Or follow me on Instagram</h3>
                    <p class="tracking-wide font-extralight sm:text-base text-sm max-sm:my-1">Stay connected and see more of my journey.</p>
                    <a href="https://www.instagram.com/alfreezzz_/" class="font-medium tracking-wider inline-flex group items-center justify-center transition" target="_blank">
                        <span class="sm:text-base text-sm text-[#C7EEFF] group-hover:underline">Follow me on Instagram</span>
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 ml-1 group-hover:translate-x-1.5 transition group-hover:-translate-y-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#C7EEFF"><path d="m256-240-56-56 384-384H240v-80h480v480h-80v-344L256-240Z"/></svg>
                    </a>
                </div>
            </div>
