<div id="about" class="scroll-section lg:mt-36 mt-32 xl:px-32 px-3 sm:px-5">
    ...
    <div class="others relative flex sm:flex-row flex-col items-center sm:px-8 px-5 sm:gap-5 gap-3 sm:mt-5 mt-9">
        ...
        <div class=" w-full border border-[#C7EEFF] sm:aspect-2/1 max-sm:min-h-32 rounded-lg flex flex-col justify-center items-center p-2 relative overflow-hidden">
            ...
            <h2 class="lg:text-lg text-xl sm:text-sm font-bold mb-3">Social Media</h2>
            <div class="flex space-x-5 sm:space-x-3 lg:space-x-4 justify-center">
                <a href="https://wa.me/6289670336495" target="_blank" class="lg:w-7 lg:h-7 hover:rotate-12 transition hover:scale-105 sm:w-5 sm:h-5 mobile-m:w-10 mobile-m:h-10 w-8 h-8">
        ...
        <div class="hobbies w-full border border-[#C7EEFF] sm:aspect-2/1 max-sm:min-h-32 rounded-lg flex flex-col justify-center items-center p-2">
            ...
            <div class="flex gap-8 w-full justify-center">
                <svg class="lg:w-12 lg:h-12 w-16 h-16 sm:w-8 sm:h-8 transition-all hover:animate-bounce" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#9D00FF"><path d="M182-200q-51 0-79-35.5T82-322l42-300q9-60 53.5-99T282-760h396q60 0 104.5 39t53.5 99l42 300q7 51-21 86.5T778-200q-21 0-39-7.5T706-230l-90-90H344l-90 90q-15 15-33 22.5t-39 7.5Zm16-86 114-114h336l114 114q2 2 16 6 11 0 17.5-6.5T800-304l-44-308q-4-29-26-48.5T678-680H282q-30 0-52 19.5T204-612l-44 308q-2 11 4.5 17.5T182-280q2 0 16-6Zm482-154q17 0 28.5-11.5T720-480q0-17-11.5-28.5T680-520q-17 0-28.5 11.5T640-480q0 17 11.5 28.5T680-440Zm-80-120q17 0 28.5-11.5T640-600q0-17-11.5-28.5T600-640q-17 0-28.5 11.5T560-600q0 17 11.5 28.5T600-560ZM310-440h60v-70h70v-60h-70v-70h-60v70h-70v60h70v70Zm170-40Z"/></svg>
                <svg class="lg:w-12 lg:h-12 w-16 h-16 sm:w-8 sm:h-8 transition-all hover:animate-pulse" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#40E0D0"><path d="M360-120H200q-33 0-56.5-23.5T120-200v-280q0-75 28.5-140.5t77-114q48.5-48.5 114-77T480-840q75 0 140.5 28.5t114 77q48.5 48.5 77 114T840-480v280q0 33-23.5 56.5T760-120H600v-320h160v-40q0-117-81.5-198.5T480-760q-117 0-198.5 81.5T200-480v40h160v320Zm-80-240h-80v160h80v-160Zm400 0v160h80v-160h-80Zm-400 0h-80 80Zm400 0h80-80Z"/></svg>
            </div>
        </div>
        {{-- Repository --}}
        <div x-data="{ repos: 0 }" x-init="fetch('https://api.github.com/users/alfreezzz')
            ...
            <h2 class="lg:text-lg text-xl sm:text-xs font-bold text-[#0077C0]">Repository</h2>
