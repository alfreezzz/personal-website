                ...
                <div class="flex max-lg:flex-col justify-between items-start mb-5">
                    ...
                    <div class="lg:w-2/3 w-full lg:ml-6">
                        <div class="flex items-center justify-between space-x-2 mb-2 max-lg:mt-3">
                            <input type="text" name="nama_apk" placeholder="App name" class="border border-[#c7eeff2f] bg-black w-full rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                            @error('nama_apk')
                                <span class="text-sm">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="lg:mt-7 mt-5 flex justify-between items-center">
                            ...
                            <input type="link" name="url" placeholder="Link (if relevant)" class="border border-[#c7eeff2f] bg-black sm:w-64 w-32 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                            @error('url')
                                <span class="text-sm">{{ $message }}</span>
                            @enderror
                        </div>
