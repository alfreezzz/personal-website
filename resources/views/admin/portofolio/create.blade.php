<x-layout-2 :title="$title">
    <div id="project" class="mt-28 xl:px-32 px-5 mx-auto">
                ...
                <div class="flex max-lg:flex-col justify-between items-start mb-5">
                    <a href="#" class="lg:w-1/3 w-full">
                        ...
                        <img src="" 
                            ...
                            class="object-cover mt-5 w-full h-52 rounded-lg border border-[#c7eeff2f] hover:border-2 hover:border-[#0077C0] transition duration-200">
                    </a>
                    
                    <div class="lg:w-2/3 w-full lg:ml-6">
                        <div class="flex items-center justify-between mb-2 max-lg:mt-3">
                            <input type="text" name="nama_apk" placeholder="App name" class="border border-[#c7eeff2f] bg-black w-96 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                            @error('nama_apk')
                                <span class="text-sm">{{ $message }}</span>
                            @enderror
                            <input type="date" name="tgl_selesai" placeholder="Finished date" class="border border-[#c7eeff2f] bg-black w-36 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                            @error('tgl_selesai')
                                <span class="text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="relative" x-data="{ isOpen: false, selected: 'App' }">
                            <button
                                type="button"
                                @click="isOpen = !isOpen"
                                class="flex lg:tracking-widest tracking-wide sm:tracking-wider items-center justify-between w-40 lg:px-4 px-3 py-1 lg:text-base text-sm text-[#C7EEFF] bg-black rounded-md shadow ring-2 ring-inset ring-[#c7eeff2f] hover:bg-gray-800"
                        ...
                        <textarea name="deskripsi" placeholder="Content" class="border border-[#c7eeff2f] bg-black w-full rounded-md px-2 py-1 resize-none mt-3 h-24 focus:outline-none focus:ring-2 focus:ring-[#0077C0]"></textarea>
                        @error('deskripsi')
                            <span>{{ $message }}</span>
                        @enderror
                        <div class="lg:mt-7 mt-5 flex justify-between items-center">
                            ...
                            <input type="link" name="url" placeholder="Link (if relevant)" class="border border-[#c7eeff2f] bg-black sm:w-64 w-36 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                            @error('url')
                                <span class="text-sm">{{ $message }}</span>
                            @enderror
                        </div>
