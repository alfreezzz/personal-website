        ...
        <form action="{{ url('blog/' . $blog->slug) }}" method="POST" enctype="multipart/form-data" class="grow-2 shrink basis-full lg:pr-5">
            ...
            <div class="leading-relaxed">
                <div class="flex justify-between">
                    ...
                    <div class="relative" x-data="{ isOpen: false, selected: '{{ $blog->jenis_artikel }}' }">
                        <button
                            type="button"
                            @click="isOpen = !isOpen"
                        ...
                        <div
                            ...
                            class="absolute z-10 mt-2 w-full bg-black rounded-md shadow-lg ring-1 ring-[#C7EEFF] focus:outline-none"
                        >
