            ...
            <form action="{{ url('experience') }}" method="POST" enctype="multipart/form-data" class="flex">
                ...
                <div class="flex">
                    <div class="lg:w-36 w-16 space-y-2"><input type="text" name="thn_mulai" placeholder="YYYY Month" class="border border-[#c7eeff2f] bg-black lg:w-32 w-16 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]"> - 
                        ...
                        @enderror
                        <input type="text" name="thn_selesai" placeholder="YYYY Month (if finished)" class="border items-end border-[#c7eeff2f] bg-black lg:w-32 w-16 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                    </div>
                </div>
                ...
                <div class="lg:ml-10 ml-5">
                    <div class="flex max-lg:flex-col">
                        <div class="flex flex-col">
                            <input type="text" name="nama_perusahaan" placeholder="Company name" class="border border-[#c7eeff2f] bg-black sm:w-80 w-36 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                        ...
                        <div class="flex flex-col">
                            <input type="text" name="posisi" placeholder="Position" class="border border-[#c7eeff2f] bg-black sm:w-80 w-36 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#0077C0]">
                            @error('posisi')
                                <span class="text-sm">{{ $message }}</span>
                            @enderror
                        </div>
